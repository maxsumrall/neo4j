...
public class IndexStatisticsWithCount extends StatisticsEntry
{
    ...
    public IndexStatisticsWithCount( int labelId, int propertyKeyId, long long1, long long2 )
    {
        super( CountsKeyType.INDEX_STATISTICS);
