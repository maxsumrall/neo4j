...
public class CountsStoreTransactionApplier extends TransactionApplier.Adapter
{
    ...
    public CountsStoreTransactionApplier( CountsAccessor.Updater countsUpdater )
    {
    ...
    {
        countsUpdater.incrementRelationshipCount( command.startLabelId(), command.typeId(), command.endLabelId(),
                command.delta() );
        return false;
    }
}
